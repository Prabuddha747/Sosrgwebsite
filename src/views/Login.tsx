        ...
        <div className="max-w-xl w-full relative z-10">
          ...
          >
            ...
            <div className="text-center mb-12 md:mb-16">
              <span className="text-[#B9914A] text-[9px] md:text-[10px] font-bold uppercase tracking-[0.5em] md:tracking-[0.6em] mb-6 md:mb-8 block italic">MEMBER ACCESS</span>
              <h2 className="text-3xl md:text-7xl font-bold text-white tracking-tighter leading-none premium-serif">
                Entry<span className="text-[#B9914A] italic font-light">.</span>
              </h2>
            </div>
            ...
            <div className="space-y-10 md:space-y-12">
              <button 
                ...
                disabled={loading}
                className="w-full py-5 md:py-6 bg-white/5 border border-white/10 flex items-center justify-center gap-4 text-white/70 hover:text-[#B9914A] hover:border-[#B9914A]/50 transition-all uppercase tracking-[0.4em] text-[9px] md:text-[10px] font-bold shadow-sm"
              >
                <Chrome size={18} className="text-[#B9914A]" /> {loading ? 'Processing...' : 'Google Identity'}
              </button>
              ...
              <form onSubmit={handleEmailLogin} className="space-y-8 md:space-y-10">
                ...
                <button 
                  disabled={loading}
                  className="w-full bg-[#B9914A] text-[#1A1A1A] py-6 md:py-8 text-[10px] md:text-[11px] font-black uppercase tracking-[0.4em] md:tracking-[0.5em] hover:bg-[#B9914A]/90 transition-all duration-500 shadow-xl shadow-black/10 flex items-center justify-center gap-4 font-sans"
                >
                  {loading ? "Decrypting..." : (
                    <>
            ...
            <div className="mt-12 md:mt-16 text-center">
              <p className="text-white/60 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.3em] italic">
                Not yet a member? <Link to="/signup" className="text-[#B9914A] hover:underline underline-offset-4 ml-2">Initiate Access</Link>
              </p>
            </div>
          </motion.div>
        </div>
